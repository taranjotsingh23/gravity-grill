...
router.post("/signup", async (req, res) => {
  ...
  if (error)
    ...
    res
      ...
      client.messages
        .create({ body: "Greetings from Gravity Grill, you have been successfully registered on our website. We are eager to serve you.", from: "+15075225207", to: "+919667938525" })
